  ...
  describe('View', () => {
    ...
    describe('When dialog is initially displayed ...', () => {
      describe('When new user is to be created ...', () => {
        ...
        return testForm({task: 'new', title: 'Benutzer anlegen', user: UserFactory.fromData(mockSingleUser())});

      });

      describe('When existing user is to be edited ...', () => {

        return testForm({task: 'edit', title: 'Benutzer pflegen', user:  UserFactory.fromData(mockSingleUser())});
      });

      describe('When my own profile is to be edited ...', () => {

        return testForm({task: 'my-profile', title: 'Meine Daten', user:  UserFactory.fromData(mockSingleUser())});
      });
    });
    ...
    describe('When dialog content is edited ...', () => {
      ...
      describe('When common fields are edited ...', () => {
        ...
        beforeEach(async () => {
          component.data = {task: 'edit', title: 'Benutzer pflegen', user:  UserFactory.fromData(mockSingleUser())};
