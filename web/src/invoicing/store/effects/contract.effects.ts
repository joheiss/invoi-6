...
export class ContractsEffects {
  ...
  updateContract$ = this.actions$.pipe(
    ...
    switchMap(contract => this.contractsService.update(ContractsService.mapToDTO(contract))
      .pipe(
  ...
  createContract$ = this.actions$.pipe(
    ...
    switchMap(contract => this.contractsService.create(ContractsService.mapToDTO(contract))
      .pipe(
  ...
  deleteContract$ = this.actions$.pipe(
    ...
    switchMap(contract => this.contractsService.delete(ContractsService.mapToDTO(contract))
      .pipe(
