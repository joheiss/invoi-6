...
import {ContractFactory, InvoiceFactory} from 'jovisco-domain';
...
describe('Invoice Item Form Component', () => {
  ...
  describe('Controller', () => {
    ...
    beforeEach(() => {
      ...
      component.item = InvoiceFactory.fromData(mockSingleInvoice()).items[0];
  ...
  describe('View', () => {
    ...
    beforeEach(() => {
      component.itemGroup = new FormGroup({});
      component.item = InvoiceFactory.fromData(mockSingleInvoice()).items[0];
      component.contract = ContractFactory.fromData(mockSingleContract());
