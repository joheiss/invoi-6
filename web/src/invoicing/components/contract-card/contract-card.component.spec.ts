  ...
  describe('View', () => {
    ...
    describe('When component is initially displayed', () => {
      ...
      it(`should show the contract start date`, async () => {
        ...
        return expect(div.textContent).toContain(datePipe.transform(component.summary.object.term.startDate, 'mediumDate'));
      });
      ...
      it(`should show the contract end date`, async () => {
        ...
        return expect(div.textContent).toContain(datePipe.transform(component.summary.object.term.endDate, 'mediumDate'));
      });
