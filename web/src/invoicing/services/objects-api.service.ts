...
import {BoHeaderData, CustomizingHeaderData, MessageContent, Messages, ReportingHeaderData} from 'jovisco-domain';

export abstract class ObjectsApiService<T extends BoHeaderData | CustomizingHeaderData | ReportingHeaderData> {
