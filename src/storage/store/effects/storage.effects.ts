...
export class StorageEffects {
  ...
  @Effect()
  downloadFileSuccess$ = this.actions$
  ...
  @Effect()
  getMetadataFileSuccess$ = this.actions$
  ...
  @Effect()
  getMetadataFileFail$ = this.actions$
  ...
  @Effect()
  updateMetadataFile$ = this.actions$
  ...
  @Effect()
  updateMetadataFileSuccess$ = this.actions$
  ...
  @Effect()
  updateMetadataFileFail$ = this.actions$
  ...
  @Effect()
  uploadFileSuccess$ = this.actions$
  ...
  @Effect()
  uploadImageSuccess$ = this.actions$
