...
describe('Contract Details Form Component', () => {
  ...
  describe('Controller', () => {
    ...
    it('should provide the correct values in the form controls', async () => {
      ...
      expect(component.form.controls['startDate'].value).toEqual(component.object.header.startDate);
      expect(component.form.controls['endDate'].value).toEqual(component.object.header.endDate);
